...
# # mesh+pi #11.3
# trainset = KNNPIShapeNetDataset('../shapenet/data/shapenet_train_18nn_GM_adaptive_knn_sparse.npy',
# 								'../shapenet/data/PD_pi/pi_00005_logistic_50_2048_a10b05_nospecs_train.npy',
# 								train=True)
# trainloader = torch.utils.data.DataLoader(trainset, batch_size=32, shuffle=True, num_workers=4,worker_init_fn=worker_init_fn)
testset = KNNPIShapeNetDataset(
    '../shapenet/data/shapenet_test_18nn_GM_adaptive_knn_sparse.npy',
    '../shapenet/data/PD_pi/pi_00005_logistic_50_2048_a10b05_nospecs_test.npy',
    train=False)
...
net = TestKNNPIGeoNetSegment_fps(3,
                                 class_nums=testset.class_nums,
                                 category_nums=testset.category_nums,
                                 device_id=device_id)  #11.4
...
load_weight = True
train_sperate = False
# net_old=torch.load('./model_param/TestKNNPIGeoNetSegment_fps_best_weight_1104_upsample.ckpt',map_location=torch.device(device_id))
# torch.save(net_old.state_dict(),'./model_param/TestKNNPIGeoNetSegment_fps_best_weight_1104_upsample_statedict.ckpt')
# raise Exception
tic = time.time()
if load_weight:
    ...
    if train_sperate:
        ...
        torch.save(net.state_dict(),
                   './model_param/knnPISphericalGeoNet_first_stage_6_8.ckpt')
        ## 2.second train kc
        ...
        torch.save(net.state_dict(),
                   './model_param/knnPISphericalGeoNet_second_stage_6_8.ckpt')
        ## 3.third train all
        ...
        torch.save(net.state_dict(),
                   './model_param/knnPISphericalGeoNet_third_stage_6_8.ckpt')
    else:
