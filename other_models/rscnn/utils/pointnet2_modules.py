...
# import pointnet2_cuda as pointnet2_utils # /usr/local..-->pointtnet2_utils
...
class _PointnetSAModuleBase(nn.Module):
    ...
    def forward(self, xyz: torch.Tensor,
        ...
        if self.npoint is not None:
            ...
            new_xyz = None
            fps_idx = None
        # debugPrint(features.size()) if features is not None else print("features is None")
...
class PointnetSAModuleMSG(_PointnetSAModuleBase):
    ...
    bn : bool
        Use batchnorm
    """
 # npoint=2, radii=[5.0, 10.0], nsamples=[6, 3], mlps=[[9, 4], [9, 6]]
    def __init__(
            self,
            *,
            npoint: int,
...
if __name__ == "__main__":
    ...
    test_module = PointnetSAModuleMSG(
        npoint=2, radii=[5.0, 10.0], nsamples=[6, 3], mlps=[[9, 4], [9, 4]] #3-->4,  6__>4
    )
    test_module.cuda()
