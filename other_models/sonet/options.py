import argparse
import os
from models.sonet.util import util
import torch
...
class Options():
    ...
    def initialize(self):
        self.parser.add_argument('--gpu_id', type=int, default=3, help='gpu id: e.g. 0, 1, 2. -1 is no GPU')

        self.parser.add_argument('--dataset', type=str, default='modelnet', help='modelnet / shrec / shapenet')
        self.parser.add_argument('--dataroot', default='/home/lingroup/Documents/zhu_code/KCNet/KCNet_Pytorch_zhu/modelnet40-normal_numpy/', help='path to images & laser point clouds')
